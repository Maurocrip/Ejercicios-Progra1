...
/**
 * @fn int calcularPromedioArrayInt(int[], int, int*)
 * @brief calcula el promedio de los datos de un array.
 *
 * @param vector: el nombre del array que se valla a promediar.
 * @param tam: el tamaño del array.
 * @param promedio: la variable dondee va a guardar el promedio hecho.
 * @return devuelve el si ah funcionado o no.
 */
int calcularPromedioArrayInt(int vector[], int tam, int* promedio);
